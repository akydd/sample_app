...
describe CommandInvoker do
  ...
  describe "valid follow commands" do
    it "should set the command to FollowCommand" do
      commands = ["follow user", "f user", "FOLLOW user", "F user", "fOllOw user", "Follow  \t\n  user", "\t\n  follow user  \t\n"]
  ...
  describe "valid unfollow commands" do
    it "should set the command to UnfollowCommand" do
      commands = ["unfollow user", "UNFOLLOW user", "unFollOW user", "unfollow  \t\n user", "  \t\nunfollow\t\t\nuser\n  "]
  ...
  describe "valid direct message commands" do
    it "should set the command to MessageCommand" do
      commands = ["d user message here", "D user message here", "dm user message here", "DM user message here", "dM user message here", "Dm user message here", "dm \t\n  user  \t\nmessage here"]
  ...
  describe "all other commands" do
    it "should default to the MicropostCommand" do
      commands = ["", "@user hello", "1st post" "@reply", "dm", "d", "DM", "f user text", "follow user text", "follow", "f", "F", "unfollow", "unfollow user invalid text", "dmuser", "followuser", "unfollowuser"]
